#!/bin/bash
#SBATCH --job-name=setup_motion2d
...
#SBATCH --output=./setup_motion2d_out.%j.out
#SBATCH --error=./setup_motion2d_err.%j.out
...
for buildtype in "${buildtypes[@]}"; do
  runcmd="${python} ${path2src}/scripts/motion2d/setup_motion2d.py \
