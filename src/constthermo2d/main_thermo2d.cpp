...
inline Observer auto create_observer(const Config &config,
  ...
  // const Observer auto obs1 = TimeObserver(obsstep, dataset, maxchunk,
  // &step2dimlesstime);
  ...
  // const Observer auto obs4 = MassMomentsObserver(obsstep, dataset, maxchunk,
  // ngbxs);

  // const Observer auto obssd = create_superdrops_observer(obsstep, dataset,
  // maxchunk);
