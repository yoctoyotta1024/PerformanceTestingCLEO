...
#SBATCH --output=./setup_cond0d_out.%j.out
#SBATCH --error=./setup_cond0d_err.%j.out
...
for buildtype in "${buildtypes[@]}"; do
  runcmd="${python} ${path2src}/scripts/condensation0d/setup_cond0d.py \
