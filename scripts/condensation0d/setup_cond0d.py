...
from condensation0d import initconds_cond0d as initconds
from pySD import editconfigfile

### ----- create temporary config file for simulation(s) ----- ###
src_config_filename = path2src / "condensation0d" / "config_cond0d.yaml"
...
savefigpath = path2builds / "bin" / "cond0d"
sharepath = path2builds / "share" / "cond0d"
binpath = path2builds / buildtype / "bin" / "cond0d"
tmppath = path2builds / buildtype / "tmp" / "cond0d"
...
for ngbxs, nsupers in ngbxs_nsupers_runs.keys():
    ...
    for nrun in range(ngbxs_nsupers_runs[(ngbxs, nsupers)]):
        for nthreads in ngbxs_nsupers_nthreads[(ngbxs, nsupers)]:
            ...
            params["zgrid"] = [0, 100, 100 / ndim_z]
            params["xgrid"] = [0, 100, 100 / ndim_x]
            params["ygrid"] = [0, 100, 100 / ndim_y]
