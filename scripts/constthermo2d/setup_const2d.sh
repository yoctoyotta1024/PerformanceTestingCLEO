...
#SBATCH --output=./setup_const2d_out.%j.out
#SBATCH --error=./setup_const2d_err.%j.out
...
for buildtype in "${buildtypes[@]}"; do
  runcmd="${python} ${path2src}/scripts/constthermo2d/setup_const2d.py \
